...
- Fix premature exit in `validate_not_empty` validation function [`b96ba3596`](https://github.com/DannyBen/bashly/commit/b96ba3596)
- Add `stacktrace` standard library [`03b78561c`](https://github.com/DannyBen/bashly/commit/03b78561c)
- Add examples/stacktrace [`52073cc77`](https://github.com/DannyBen/bashly/commit/52073cc77)
- Compare [`v1.2.12..v1.2.13`](https://github.com/dannyben/bashly/compare/v1.2.12..v1.2.13)


v1.2.12 - 2025-05-02
----------------------------------------

- Drop support for Ruby 3.1 [`a735ee00d`](https://github.com/DannyBen/bashly/commit/a735ee00d)
- Fix validations to only run once [`a3075a024`](https://github.com/DannyBen/bashly/commit/a3075a024)
- Add settings for internal function names [`8fa881e28`](https://github.com/DannyBen/bashly/commit/8fa881e28)
...
- Fix quoted heredocs [`4b264646a`](https://github.com/DannyBen/bashly/commit/4b264646a)
...
- Add `header_override` command option [`d7a57e475`](https://github.com/DannyBen/bashly/commit/d7a57e475)
- Rename `header_override` to `help_header_override` [`2a8b5ded7`](https://github.com/DannyBen/bashly/commit/2a8b5ded7)
- Add example for `help_header_override` [`aa00c7510`](https://github.com/DannyBen/bashly/commit/aa00c7510)
- Update JSON schema with `help_header_override` [`6677f4da7`](https://github.com/DannyBen/bashly/commit/6677f4da7)
- Update `bashly doc` with `command.help_header_override` [`4e50fe17e`](https://github.com/DannyBen/bashly/commit/4e50fe17e)
...
- Update colors library to support auto-colors based on TTY [`a4bbae9a7`](https://github.com/DannyBen/bashly/commit/a4bbae9a7)
- Add `--quiet` to `bashly add` command [`ca0a54688`](https://github.com/DannyBen/bashly/commit/ca0a54688)
- Update documentation domain to bashly.dev [`d05605cb9`](https://github.com/DannyBen/bashly/commit/d05605cb9)
...
- Add support for avoiding execution if the script is sourced [`4d83222ba`](https://github.com/DannyBen/bashly/commit/4d83222ba)
- Revert 9167c49 to allow calling `run ...` internally [`d25c718fc`](https://github.com/DannyBen/bashly/commit/d25c718fc)
- Declare `version` and `long_usage` as globals for consistency and clarity of intent [`e9a9a76fa`](https://github.com/DannyBen/bashly/commit/e9a9a76fa)
- Move `long_usage` definition from `initialize` to `run` [`54beb86ef`](https://github.com/DannyBen/bashly/commit/54beb86ef)
- Add Internal Run example [`4a1b2b9b8`](https://github.com/DannyBen/bashly/commit/4a1b2b9b8)
- Add support for whalebrew [`f33c663bc`](https://github.com/DannyBen/bashly/commit/f33c663bc)
...
- Update version specifications for all dependencies [`6bf0c4a04`](https://github.com/DannyBen/bashly/commit/6bf0c4a04)
- Add support for tweaking production/development output [`c23d7053b`](https://github.com/DannyBen/bashly/commit/c23d7053b)
- Fix shellcheck unused variable on `other_args` in production [`f78c6e9ae`](https://github.com/DannyBen/bashly/commit/f78c6e9ae)
- Fix view markers for user files [`cc3896edb`](https://github.com/DannyBen/bashly/commit/cc3896edb)
- Update dependency check to show all missing dependencies at once [`492510645`](https://github.com/DannyBen/bashly/commit/492510645)
- Add support for declaring aliases for internal global variables [`5264d511c`](https://github.com/DannyBen/bashly/commit/5264d511c)
- Move global var declarations from `run()` to `initialize()` [`9167c4989`](https://github.com/DannyBen/bashly/commit/9167c4989)
- Update settings JSON schema [`b4e7e4dd4`](https://github.com/DannyBen/bashly/commit/b4e7e4dd4)
- Add `build` as an alias to `bashly generate` [`d64bc3672`](https://github.com/DannyBen/bashly/commit/d64bc3672)
- Update default script header [`c85276cde`](https://github.com/DannyBen/bashly/commit/c85276cde)
...
- Fix array variables scope [`ed7f24043`](https://github.com/DannyBen/bashly/commit/ed7f24043)
...
- Move root variables from `run()` to `initialize()` [`f76c53b63`](https://github.com/DannyBen/bashly/commit/f76c53b63)
...
- Add `command.variables` as a convenience utility for defining global command variables [`653888684`](https://github.com/DannyBen/bashly/commit/653888684)
- Update JSON schema to include `command.variables` [`28953fb52`](https://github.com/DannyBen/bashly/commit/28953fb52)
- Refactor `command.variables` to a new `Variable` object [`3e5a06069`](https://github.com/DannyBen/bashly/commit/3e5a06069)
- Add black and white to color library [`0573e0f5d`](https://github.com/DannyBen/bashly/commit/0573e0f5d)
...
- Fix docker image for multi-arch [`5660a3e33`](https://github.com/DannyBen/bashly/commit/5660a3e33)
- Fix INI library when loading multiple files [`6bfb1bc07`](https://github.com/DannyBen/bashly/commit/6bfb1bc07)
- Add sub dependencies to avoid Ruby 3.3.5 warnings [`30b7318a9`](https://github.com/DannyBen/bashly/commit/30b7318a9)
- Fix `conflicts` in fixed flags [`152069af7`](https://github.com/DannyBen/bashly/commit/152069af7)
...
- Add support for needy flags: `flag.needs` [`fadda94d8`](https://github.com/DannyBen/bashly/commit/fadda94d8)
- Add needy flag example [`43e3b386f`](https://github.com/DannyBen/bashly/commit/43e3b386f)
- Update JSON schemas [`868650c6a`](https://github.com/DannyBen/bashly/commit/868650c6a)
- Update flag usage to show its conflicts and needs [`db23575c3`](https://github.com/DannyBen/bashly/commit/db23575c3)
- Refactor Command#introspection [`a66db36f3`](https://github.com/DannyBen/bashly/commit/a66db36f3)
- Add support for environment variable validations [`bccd3b028`](https://github.com/DannyBen/bashly/commit/bccd3b028)
- Update validations example to show environment variable validation [`ee6a4c997`](https://github.com/DannyBen/bashly/commit/ee6a4c997)
- Update script generation to allow bash variables in some YAML strings [`6660d1680`](https://github.com/DannyBen/bashly/commit/6660d1680)
- Allow ad-hoc revealing of private commands, flags, and environment variables [`d2876d728`](https://github.com/DannyBen/bashly/commit/d2876d728)
- Add private-reveal example [`8c940429b`](https://github.com/DannyBen/bashly/commit/8c940429b)
- Update completions library to consider private visibility setting [`e16dde102`](https://github.com/DannyBen/bashly/commit/e16dde102)
- Update mandoc/markdown library to consider private visibility setting [`c49d94df1`](https://github.com/DannyBen/bashly/commit/c49d94df1)
...
- Add validation to disallow required args before optional [`f2d62764b`](https://github.com/DannyBen/bashly/commit/f2d62764b)
- Fix shellcheck violations and reduce use of `eval` [`41da133a7`](https://github.com/DannyBen/bashly/commit/41da133a7)
- Fix default command not being triggered when only flags are provided [`c65983004`](https://github.com/DannyBen/bashly/commit/c65983004)
- Fix prompt in bashly shell [`de231e899`](https://github.com/DannyBen/bashly/commit/de231e899)
...
- Fix usage string when there is a forced default command [`d50607bee`](https://github.com/DannyBen/bashly/commit/d50607bee)
- Add 'Global options' caption when appropriate [`105a0f893`](https://github.com/DannyBen/bashly/commit/105a0f893)
- Update descriptions in schemas/strings.json [`6592666f7`](https://github.com/DannyBen/bashly/commit/6592666f7)
- Remove redundant code in usage function [`f87986a7d`](https://github.com/DannyBen/bashly/commit/f87986a7d)
- Update default command usage to show optional brackets [`854036d5c`](https://github.com/DannyBen/bashly/commit/854036d5c)
- Add `show_examples_on_error` setting [`5e58388d1`](https://github.com/DannyBen/bashly/commit/5e58388d1)
- Add examples/command-examples-on-error [`b30d2aa11`](https://github.com/DannyBen/bashly/commit/b30d2aa11)
...
- Sanitize percent signs in help messages [`1f7e27c5c`](https://github.com/DannyBen/bashly/commit/1f7e27c5c)
- Drop support for Ruby 3.0 [`865d6ac7b`](https://github.com/DannyBen/bashly/commit/865d6ac7b)
- Fix input normalization to ignore anything after the double dash (--) operator [`621a15130`](https://github.com/DannyBen/bashly/commit/621a15130)
- Add `[--]` to usage text when `catch_all` is used [`1422bcf3b`](https://github.com/DannyBen/bashly/commit/1422bcf3b)
- Add `conjoined_flag_args` to allow disabling the `--flag=arg` normalization [`d17756d2d`](https://github.com/DannyBen/bashly/commit/d17756d2d)
...
- Fix repeatable args when the input has quotes [`0d35217bb`](https://github.com/DannyBen/bashly/commit/0d35217bb)
- Fix repeatable flag args when the input has quotes [`ab34fc059`](https://github.com/DannyBen/bashly/commit/ab34fc059)
- Improve handling of unique repeatable args and flag args [`c200223a7`](https://github.com/DannyBen/bashly/commit/c200223a7)
- Update `Approvals.bash` to v0.5.1 [`8e12d559f`](https://github.com/DannyBen/bashly/commit/8e12d559f)
...
- Update `approvals.bash` to v0.5.0 [`530cb05d1`](https://github.com/DannyBen/bashly/commit/530cb05d1)
- Add support for using heredoc [`adf4837f5`](https://github.com/DannyBen/bashly/commit/adf4837f5)
...
- Refactor validations to run after assigning default values [`e45580cd2`](https://github.com/DannyBen/bashly/commit/e45580cd2)
- Upgrade `approvals.bash` to 0.4.2 [`863bf9a5d`](https://github.com/DannyBen/bashly/commit/863bf9a5d)
...
- Docker: Fix missing pandoc [`b8f6d2cfb`](https://github.com/DannyBen/bashly/commit/b8f6d2cfb)
- Avoid rendering `inspect_args()` when generating for production env [`dbb8816b0`](https://github.com/DannyBen/bashly/commit/dbb8816b0)
- Update `approvals.bash` library to 0.4.1 [`9eee25ca4`](https://github.com/DannyBen/bashly/commit/9eee25ca4)
- Update Dockerfile [`453449725`](https://github.com/DannyBen/bashly/commit/453449725)
- Build multi-arch docker image using GitHub Actions [`5d169261d`](https://github.com/DannyBen/bashly/commit/5d169261d)
...
- Allow `flag.default` and `arg.default` to be an array if `repeatable` is true [`00c81ec1d`](https://github.com/DannyBen/bashly/commit/00c81ec1d)
- Improve JSON schema tests [`6bd7a1b62`](https://github.com/DannyBen/bashly/commit/6bd7a1b62)
- Add YAML schema as a source to the bashly JSON schema [`261d1040c`](https://github.com/DannyBen/bashly/commit/261d1040c)
- Add `allowed` option to `environment_variable` [`4d313a864`](https://github.com/DannyBen/bashly/commit/4d313a864)
- Update `inspect_args` to also print managed `environment_variables` [`4fe17b71c`](https://github.com/DannyBen/bashly/commit/4fe17b71c)
- Refactor `inspect_args` handling of environment variables [`7c6e71240`](https://github.com/DannyBen/bashly/commit/7c6e71240)
...
- Fix example in `bashly doc flag.arg` [`039ab1cb3`](https://github.com/DannyBen/bashly/commit/039ab1cb3)
- Add support for `unique` in repeatable flag args [`b062c9349`](https://github.com/DannyBen/bashly/commit/b062c9349)
- Disallow multiple repeatable args, and a repeatable arg that is not the last one [`25431c9ef`](https://github.com/DannyBen/bashly/commit/25431c9ef)
- Add support for `unique` in repeatable args [`4486788fd`](https://github.com/DannyBen/bashly/commit/4486788fd)
...
- Fix `bashly completeions --install` [`9e5d45a0e`](https://github.com/DannyBen/bashly/commit/9e5d45a0e)
...
- Fix shfmt excess newlines violation when using `--env production` [`0938fca13`](https://github.com/DannyBen/bashly/commit/0938fca13)
- Fix some incompatibilities with strict mode [`b24cddff8`](https://github.com/DannyBen/bashly/commit/b24cddff8)
...
- Upgrade `approvals.bash` library to version 0.4.0 [`a68ad34f0`](https://github.com/DannyBen/bashly/commit/a68ad34f0)
- Update INI library to allow using environment variables in the INI values [`2e3aec7ff`](https://github.com/DannyBen/bashly/commit/2e3aec7ff)
- Add support for custom "See Also" in mandoc renderer (`x_mandoc_see_also`) [`4fddc7bf3`](https://github.com/DannyBen/bashly/commit/4fddc7bf3)
- Fix missing tmpdir library in `bashly add --source` [`3f7b4c3a4`](https://github.com/DannyBen/bashly/commit/3f7b4c3a4)
- Validate libraries.yml [`a44cbde9d`](https://github.com/DannyBen/bashly/commit/a44cbde9d)
...
- Add `bashly render` command [`4acc67bd8`](https://github.com/DannyBen/bashly/commit/4acc67bd8)
- Add ability to render markdown documentation [`7db612910`](https://github.com/DannyBen/bashly/commit/7db612910)
- Refactor module loading with autoload [`62184f0f5`](https://github.com/DannyBen/bashly/commit/62184f0f5)
- Add `bashly add render_markdown` library [`d0fada7dc`](https://github.com/DannyBen/bashly/commit/d0fada7dc)
- Add ability to render man pages and `bashly add render_mandoc` library [`fe9607b48`](https://github.com/DannyBen/bashly/commit/fe9607b48)
- Refactor render command with RenderSource model [`8629d2668`](https://github.com/DannyBen/bashly/commit/8629d2668)
- Allow arbitrary (`x-anything`) values in bashly.yml [`906278336`](https://github.com/DannyBen/bashly/commit/906278336)
- Refactor mandoc template to use x_mandoc_footer and x_mandoc_authors [`b44b91f9f`](https://github.com/DannyBen/bashly/commit/b44b91f9f)
- Add render-mandoc man page generation example [`98420de1b`](https://github.com/DannyBen/bashly/commit/98420de1b)
- Add `--show` to `bashly render` [`2fcd790ba`](https://github.com/DannyBen/bashly/commit/2fcd790ba)
